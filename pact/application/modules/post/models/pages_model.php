...
class Pages_model extends CI_Model
{
	...
	{	
		$sql = "SELECT * FROM `tbl_post` AS p LEFT JOIN `tbl_static_pages_category` AS c ON p.pc_id= c.id";
	...
	{
		$sql = "SELECT * FROM `tbl_static_pages_category` AS c LEFT JOIN `tbl_post` AS p ON p.pc_id= c.id";
		if($where)
		$sql.= ' where'." ".$where;
