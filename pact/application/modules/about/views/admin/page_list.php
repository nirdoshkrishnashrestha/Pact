...
?>
  <div class="titlebar" align="center" >
        <h1 align="left">Manage <?php echo "About Us";//@$page_title?> 
         <span>View or edit existing About Us Contents.
            </span>           
        </h1>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <thead>
        <tr>
          ...
          <th style="text-align:left;" width="30%">Page Slug</th>
          <th width="9%">Order</th>
			  ...
			  <td style="text-align:left;"><?php echo $count?></td>            	
				...
				<td>
                	<span class="table-icons">
                    	<a href="<?php echo base_url()?>admin/about/edit/<?php echo $row->id?>" class="edit editRow icons-table-actions icon-edit-table-action" title="Edit">Edit</a>
                  </span>
                </td>
                </tr>
    <?php
