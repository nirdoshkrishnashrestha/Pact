...
?>
  <div class="titlebar" align="center" >
        <h1 align="left">Manage Pages 
         <span>View, edit or delete existing pages and
            <a href="<?php echo base_url('admin/pages/add'.$addlink)?>" class="btn create-add" id="CreateNew">Create/add new  Pages</a>  	 as well.
            </span>           
        </h1>
...
<div class="page-searchbar" align="left">    
            <form method="get" action="">             
                <select name="pagetype" id="status" onchange="form.submit();" class="selectType">                
                <?php
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <thead>
        <tr>
          ...
          <th style="text-align:left;" width="20%">English Title</th>
           <th style="text-align:left;" width="20%">Nepali Title</th>
		...
		?>
			<tr class="<?php echo ($count%2==0)?'even':'odd'?>">
			  <td style="text-align:left;"><?php echo $count?></td>            	
                ...
                <td style="text-align:left;"><?php echo $row->page_title_nepali?></td>
				<td><?php echo $row->page_slug?></td>
				<td><?php echo $row->order?></td>
										
				<td>
                	<span class="table-icons">
                    	<a href="<?php echo base_url()?>admin/pages/edit/<?php echo $row->id?>" class="edit editRow icons-table-actions icon-edit-table-action" title="Edit">Edit</a>&nbsp;&nbsp;<a href="<?php echo base_url()?>admin/pages/delete/<?php echo $row->id?>" class="deleteRow icons-table-actions icon-delete-table-action" title="Delete" onclick="return confirm('Are you sure')">Delete</a>
                        </span>
                </td>
                </tr>
    <?php
