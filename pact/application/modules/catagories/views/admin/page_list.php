...
?>
  <div class="titlebar" align="center" >
        <h1 align="left">Manage <?php echo "catagories";//@$page_title?> 
         <span>View, edit or delete existing pages and
            <a href="<?php echo base_url('admin/catagories/add'.$addlink)?>" class="btn create-add" id="CreateNew">Create/add new Category </a>  	 as well.
            </span>           
        </h1>
		...
		?>
			<tr class="<?php echo ($count%2==0)?'even':'odd'?>">
			  <td style="text-align:left;"><?php echo $count?></td>            	
				...
				<td><?php echo mb_strimwidth($row->html_describe, 0, 50, '...'); ?></td>          
				<td><?php echo $row->order?></td>
											
				<td>
                	<span class="table-icons">
                    	<a href="<?php echo base_url()?>admin/catagories/edit/<?php echo $row->id?>" class="edit editRow icons-table-actions icon-edit-table-action" title="Edit">Edit</a>&nbsp;&nbsp;<a href="<?php echo base_url()?>admin/catagories/delete/<?php echo $row->id?>" class="deleteRow icons-table-actions icon-delete-table-action" title="Delete" onclick="return confirm('Are you sure')">Delete</a>
                  </span>
                </td>
                </tr>
    <?php
